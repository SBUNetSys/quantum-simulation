...
def example_network_setup(source_delay=1e5, source_fidelity_sq=0.8, memeory_depolar_rate=10,
    ...
    for index, node in enumerate(nodes):
        ...
        if index - 1 >= 0:
            ...
            node.add_subcomponent(QuantumProcessor(name=nodes[index - 1].name + "_qmemory",
                                                   ...
                                                   memory_noise_models=[DepolarNoiseModel(memeory_depolar_rate)] * 10))
