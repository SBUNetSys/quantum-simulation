...
class DirectionalEntanglementProtolMultiMem(NodeProtocol):
    ...
    def __init__(self, node, start_expression=None,
        ...
        :param node: the node on which the protocol is running
        :param start_expression:
        :param input_mem_pos: specifies the memory position to expect incoming qubits on
        :param total_num_pairs: maximum number of entanglement pairs will be hold by the node (left + right)
        :param name: name of the protocol
        :param left_node: left node's ID or name
        :param right_node: right node's ID or name
        """
